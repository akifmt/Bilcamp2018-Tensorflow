...
def main(_):
    #FLAGS.csv_input = 'data/test_labels.csv'
    #FLAGS.output_path = 'test.record'

    #FLAGS.csv_input = 'data/train_labels.csv'
    #FLAGS.output_path = 'train.record'

    writer = tf.python_io.TFRecordWriter(FLAGS.output_path)

    #train record ve test record icin ayri
    if FLAGS.output_path == 'train.record':
        path = os.path.join(os.getcwd(), 'images/train')
    elif FLAGS.output_path == 'test.record':
        path = os.path.join(os.getcwd(), 'images/test')
    else:
        print('record name hatali gecersiz....')
